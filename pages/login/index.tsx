              ...
              {(formik) => (
                ...
                >
                  ...
                  <div className="flex justify-between pt-5">
                    <a
                      href="#"
                      className="font-medium text-blue-500 dark:text-blue-600 hover:underline"
                    >
                      Utwórz konto
                    </a>
                    <a
                  ...
                  <div className="mt-16 grid space-y-4">
                    <button
                      className="group h-12 px-6 border rounded-full transition duration-300 
